...
class AirForm extends StatefulWidget {
  const AirForm({super.key});

  @override
  State<AirForm> createState() => _AirFormState();
}
...
// Function to submit form with all data including the image
  Future<void> _submitForm() async {
    ...
    try {
      ...
      var uri = Uri.parse('https://enviroment.technounityopdc.com/api/AirAPI/Create');
      var request = http.MultipartRequest('POST', uri);

      // 2. إضافة الهيدر المطلوب
      request.headers['Hdr-Create-Air'] = 'Air-2025-OK';
