...
class LpgForm extends StatefulWidget {
  const LpgForm({super.key});

  @override
  State<LpgForm> createState() => _LpgFormState();
}

class _LpgFormState extends State<LpgForm> {
  ...
  Future<void> _submitForm() async {
    ...
    try {
      var uri = Uri.parse('https://enviroment.technounityopdc.com/api/LPGApi/Create');
      var request = http.MultipartRequest('POST', uri);

      request.headers['Hdr-Create'] = 'Create-2025-OK';

      request.fields['CityId'] = selectedMohafazaId.toString();
      request.fields['GasStationId'] = selectedStationId.toString();
      request.fields['Ownership'] = selectedAidiya!;
      request.fields['LPGDate'] = selectedDate!.toIso8601String();
                    ...
                    child: Column(
                      children: [
                        ...
                        _buildDropdownField(
                          ...
                          items: stations,
                          isLoading: _isLoadingStations, // Added loading state
                          onChanged: (value) {
                            setState(() {
